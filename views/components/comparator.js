$(function(){
    ...
    async function updateImages(formId,formBoxId) {
        ...
        .done(function(data) {
            if(data.length != 0){
                // Log the length of the data to verify it's not empty
                console.log('Data Length:', data.length);
                console.log(imageDiv)
                // Log the path for each image
                ...
                filledForms.forEach((form)=>{
                    ...
                    .done(function(data) {
                        if(data.length != 0){
                            ...
                            console.log(data);
                            sessionStorage.setItem(`comparitionData${form}`, JSON.stringify(comparisonData));
                        } else{
                            console.log('no data')
                        }
                    })
